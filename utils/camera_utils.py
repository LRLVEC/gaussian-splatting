...
def loadCam(args, id, cam_info, resolution_scale, lazy_load):
    if cam_info.image == None:
    ...
    return Camera(colmap_id=cam_info.uid,
                  ...
                  FoVy=cam_info.FovY,
                  K=cam_info.K,
                  focalx=cam_info.focalx / scale,
                  focaly=cam_info.focaly / scale,
...
def cameraList_from_camInfos(cam_infos, resolution_scale, args, lazy_load):
    ...
    for id, cam_info in enumerate(cam_infos):
        camera_list.append(loadCam(args, id, cam_info, resolution_scale, lazy_load))
